    ...
    >
      <div className="container mx-auto px-4 md:px-8 flex items-center justify-between relative z-50">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Link href="/notre-processus" onMouseEnter={() => setActiveDropdown(null)} className="text-sm font-bold text-blue-600 hover:text-blue-800 transition-colors">
            Notre Processus
          </Link>
        </div>
          ...
          >
            <div className="flex flex-col gap-6">
              <div className="space-y-4">
                ...
                <Link href="/notre-processus" onClick={() => setMobileMenuOpen(false)} className="block text-lg font-bold text-blue-600">
                  Notre Processus
                </Link>
              </div>
