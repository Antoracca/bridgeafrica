    ...
    <section className="bg-[#fafafa] font-sans pb-16 pt-20 border-t border-[#EAEAEA]">
      <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-14">
             ...
             {baseFeatures.map((feat, i) => {
               ...
               return (
                 <motion.div 
                   ...
                   className={`relative bg-slate-900 p-6 md:p-8 aspect-square sm:aspect-[4/5] lg:aspect-square flex flex-col group transition-all shadow-md hover:shadow-2xl hover:shadow-brand-teal/20 ${mtClasses[i]}`}
                 >
                   {/* Container Image (overflow hidden to keep scaling strictly inside) */}
                   <div className="absolute inset-0 overflow-hidden z-0">
                     <img src={feat.image} className="w-full h-full object-cover scale-100 group-hover:scale-110 transition-transform duration-700 ease-out opacity-40 mix-blend-screen" alt={feat.title} />
                     <div className="absolute inset-0 bg-gradient-to-t from-[#020617] via-[#020617]/80 to-[#020617]/10"></div>
                     <div className="absolute inset-0 border border-slate-700/50 group-hover:border-brand-teal/50 transition-colors"></div>
                   </div>

                   {/* Titre surélevé façon onglet de catalogue, le fond #fafafa coupe la bordure */}
                   <div className="absolute -top-3.5 left-4 bg-[#fafafa] px-3 z-20">
                     <h4 className="text-[15px] font-bold text-slate-900" style={{ fontFamily: 'Georgia, serif' }}>
                       {feat.title}
                     </h4>
                   </div>
                   
                   <div className="mt-auto relative z-10">
                     <div className="w-8 h-[2px] bg-brand-teal mb-4 scale-x-0 group-hover:scale-x-100 transition-transform origin-left duration-500"></div>
                     <p className="text-[13px] text-slate-200 leading-relaxed font-light">{feat.desc}</p>
                   </div>
                 </motion.div>
               )
             })}
        ...
        <div className="mb-0">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-0 border border-slate-200 shadow-sm mb-8">
            
            {/* 1. Particuliers */}
            <div className="bg-white p-10 lg:p-12 border-b lg:border-b-0 lg:border-r border-slate-200 hover:bg-slate-50 transition-colors flex flex-col">
              <div className="flex items-center justify-center w-12 h-12 bg-slate-100 mb-6 rounded-none">
                 <UserCircle size={24} className="text-slate-600" strokeWidth={1.5} />
              </div>
              <h4 className="text-2xl text-slate-900 mb-4" style={{ fontFamily: 'Georgia, serif' }}>Patients Particuliers</h4>
            ...
            <div className="bg-white p-10 lg:p-12 border-b lg:border-b-0 lg:border-r border-slate-200 hover:bg-slate-50 transition-colors flex flex-col">
              <div className="flex items-center justify-center w-12 h-12 bg-brand-teal/10 mb-6 rounded-none">
                 <BriefcaseBusiness size={24} className="text-brand-teal" strokeWidth={1.5} />
              </div>
              <h4 className="text-2xl text-slate-900 mb-4" style={{ fontFamily: 'Georgia, serif' }}>Entreprises & DRH</h4>
              <p className="text-slate-500 font-light leading-relaxed mb-8 flex-1">
            ...
            {/* 3. Assurances */}
            <div className="bg-white p-10 lg:p-12 hover:bg-slate-50 transition-colors flex flex-col relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-slate-50 rounded-full blur-3xl -z-0"></div>
              <div className="relative z-10 flex items-center justify-center w-12 h-12 bg-blue-50 mb-6 rounded-none">
                 <HeartHandshake size={24} className="text-blue-600" strokeWidth={1.5} />
              </div>
              <h4 className="text-2xl text-slate-900 mb-4 relative z-10" style={{ fontFamily: 'Georgia, serif' }}>Compagnies d'Assurance</h4>
              <p className="text-slate-500 font-light leading-relaxed mb-6 relative z-10">
              ...
              {/* Vrais Logos Assurances (Sources vectorielles directes sur Wikimedia Commons/EN) */}
              <div className="flex items-center justify-between gap-4 mt-auto border-t border-slate-100 pt-6 relative z-10">
                 <img src="https://upload.wikimedia.org/wikipedia/commons/6/6e/Allianz_logo.svg" alt="Allianz" className="h-4 w-auto grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition-all duration-300 object-contain mix-blend-multiply" />
                 <img src="https://upload.wikimedia.org/wikipedia/commons/9/94/AXA_Logo.svg" alt="AXA" className="h-4 w-auto grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition-all duration-300 object-contain mix-blend-multiply" />
                 <img src="https://upload.wikimedia.org/wikipedia/en/5/5f/Cigna_logo.svg" alt="Cigna" className="h-4 w-auto grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition-all duration-300 object-contain mix-blend-multiply" />
                 <img src="https://upload.wikimedia.org/wikipedia/en/3/33/Bupa_logo.svg" alt="Bupa" className="h-5 w-auto grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition-all duration-300 object-contain mix-blend-multiply" />
              </div>
            </div>
