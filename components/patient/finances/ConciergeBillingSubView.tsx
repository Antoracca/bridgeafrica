...
export function ConciergeBillingSubView({ onBack }: Props) {
  const items = [
    {
      id: "con-1",
      title: "Lettre d'Invitation Consulaire & Visa Médical Express",
      desc: "Émission du justificatif hospitalier officiel et facilitation consulaire",
      amount: 0,
      covered: 0,
      patientShare: 0,
      status: "Inclus",
    ...
    {
      id: "con-2",
      title: "Coordinateur Médical Référent Dédié (24h/24 & 7j/7)",
      desc: "Accompagnement continu, liaison médicale et gestion des imprévus",
      amount: 0,
      covered: 0,
      patientShare: 0,
      status: "Inclus",
    ...
    {
      id: "con-3",
      title: "Interprétariat & Traduction Assermentée des Bilans",
      desc: "Traduction des antécédents, comptes rendus opératoires et ordonnances",
      amount: 0,
      covered: 0,
      patientShare: 0,
      status: "Sur demande",
    ...
    {
      id: "con-4",
      title: "Carte SIM Locale & Connectivité Immédiate",
      desc: "Ligne 4G/5G fournie à l'arrivée pour garder le contact avec vos proches",
      amount: 0,
      covered: 0,
      patientShare: 0,
      status: "Inclus",
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-[#F4F2EE] border border-[#E2DDD7] rounded-[24px] p-5 flex flex-col justify-between">
          <span className="text-xs font-bold text-[#696969] uppercase tracking-wider">Total Conciergerie</span>
          <span className="text-2xl sm:text-3xl font-medium text-[#141413] tracking-tight mt-3">0 FCFA</span>
          <span className="text-[11px] text-[#696969] mt-1">Forfait coordination</span>
        </div>
        ...
        <div className="bg-[#F4F2EE] border border-[#E2DDD7] rounded-[24px] p-5 flex flex-col justify-between">
          ...
          <span className="text-2xl sm:text-3xl font-medium text-[#141413] tracking-tight mt-3">0 FCFA</span>
          <span className="text-[11px] text-[#696969] mt-1">Services inclus</span>
        </div>
      ...
      <div className="space-y-4 pt-2">
        <div className="flex items-center justify-between pb-3 border-b border-[#E2DDD7]">
          <h3 className="text-lg sm:text-xl font-medium text-[#141413] tracking-tight">
            Services Administratifs & Conciergerie Dédiée
          </h3>
      ...
      <div className="p-5 rounded-[20px] bg-[#F4F2EE] border border-[#E2DDD7] flex items-start gap-3.5 text-xs text-[#696969]">
        ...
        <p className="leading-relaxed">
          Votre coordinateur dédié Pont Afrique Santé vous accompagne du premier échange jusqu'au suivi post-opératoire de retour chez vous.
        </p>
      </div>
    </div>
  )
