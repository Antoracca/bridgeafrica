...
export function TransportBillingSubView({ onBack }: Props) {
  const items = [
    {
      id: "trans-1",
      title: "Accueil & Transfert Aéroport Dédié",
      desc: "Chauffeur privé avec véhicule climatisé aller-retour aéroport/résidence",
      amount: 0,
      covered: 0,
      patientShare: 0,
      status: "Non engagé",
    ...
    {
      id: "trans-2",
      title: "Navettes Quotidiennes Résidence - Clinique",
      desc: "Déplacements pour consultations, soins et bilans pré/post-opératoires",
      amount: 0,
      covered: 0,
      patientShare: 0,
      status: "Non engagé",
    ...
    {
      id: "trans-3",
      title: "Ambulance Médicalisée Conventionnée (Si requis)",
      desc: "Véhicule sanitaire avec équipement d'assistance et personnel soignant",
      amount: 0,
      covered: 0,
      patientShare: 0,
      status: "Non engagé",
    ...
    <div className="space-y-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <h2 className="text-2xl sm:text-3xl font-medium text-[#141413] tracking-tight">
              Transport & Transferts Médicalisés
            </h2>
          </div>
        </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-[#F4F2EE] border border-[#E2DDD7] rounded-[24px] p-5 flex flex-col justify-between">
          <span className="text-xs font-bold text-[#696969] uppercase tracking-wider">Total Transport</span>
          <span className="text-2xl sm:text-3xl font-medium text-[#141413] tracking-tight mt-3">0 FCFA</span>
          <span className="text-[11px] text-[#696969] mt-1">Forfait global</span>
        </div>
      ...
      <div className="p-5 rounded-[20px] bg-[#F4F2EE] border border-[#E2DDD7] flex items-start gap-3.5 text-xs text-[#696969]">
        ...
        <p className="leading-relaxed">
          Les chauffeurs et ambulances sont conventionnés et coordonnés avec les horaires de vos rendez-vous médicaux pour vous garantir une ponctualité absolue sans stress.
        </p>
      </div>
    </div>
  )
