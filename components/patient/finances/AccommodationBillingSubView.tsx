...
export function AccommodationBillingSubView({ onBack }: Props) {
  const items = [
    {
      id: "acc-1",
      title: "Hôtel Partenaire 4★ / 5★ ou Appart-Hôtel PMR",
      desc: "Chambre adaptée avec ascenseur, literie ergonomique et proximité clinique",
      amount: 0,
      covered: 0,
      patientShare: 0,
      status: "Non engagé",
    ...
    {
      id: "acc-2",
      title: "Hébergement Accompagnant (Optionnel)",
      desc: "Chambre double ou lit d'appoint avec petits déjeuners inclus",
      amount: 0,
      covered: 0,
      patientShare: 0,
      status: "Optionnel",
    ...
    {
      id: "acc-3",
      title: "Restauration Adaptée & Régime Médical",
      desc: "Repas adaptés aux prescriptions diététiques post-intervention",
      amount: 0,
      covered: 0,
      patientShare: 0,
      status: "Sur demande",
    ...
    {
      id: "acc-4",
      title: "Taxes de Séjour & Frais Hôteliers",
      desc: "Taxes locales obligatoires et frais de conciergerie de résidence",
      amount: 0,
      covered: 0,
      patientShare: 0,
      status: "Non engagé",
    ...
    <div className="space-y-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <h2 className="text-2xl sm:text-3xl font-medium text-[#141413] tracking-tight">
              Hébergement & Résidences Partenaires
            </h2>
          </div>
        </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-[#F4F2EE] border border-[#E2DDD7] rounded-[24px] p-5 flex flex-col justify-between">
          <span className="text-xs font-bold text-[#696969] uppercase tracking-wider">Total Hébergement</span>
          <span className="text-2xl sm:text-3xl font-medium text-[#141413] tracking-tight mt-3">0 FCFA</span>
          <span className="text-[11px] text-[#696969] mt-1">Estimation séjour</span>
        </div>
        ...
        <div className="bg-[#F4F2EE] border border-[#E2DDD7] rounded-[24px] p-5 flex flex-col justify-between">
          ...
          <span className="text-2xl sm:text-3xl font-medium text-[#141413] tracking-tight mt-3">0 FCFA</span>
          <span className="text-[11px] text-[#696969] mt-1">Forfait intégré</span>
        </div>
      ...
      <div className="space-y-4 pt-2">
        <div className="flex items-center justify-between pb-3 border-b border-[#E2DDD7]">
          <h3 className="text-lg sm:text-xl font-medium text-[#141413] tracking-tight">
            Postes d'Hébergement & Convalescence
          </h3>
      ...
      <div className="p-5 rounded-[20px] bg-[#F4F2EE] border border-[#E2DDD7] flex items-start gap-3.5 text-xs text-[#696969]">
        ...
        <p className="leading-relaxed">
          Toutes nos résidences partenaires bénéficient d'un protocole d'accessibilité PMR et de proximité directe (moins de 15 minutes) avec les cliniques et hôpitaux conventionnés.
        </p>
      </div>
    </div>
  )
