-- ============================================================================
-- FIX: Trigger pour inscription manuelle qui ne crée pas le profil
-- ============================================================================
-- Problème potentiel: Exception non gérée ou contrainte CHECK qui bloque
-- Solution: Trigger ultra-robuste qui ne bloque JAMAIS
-- ============================================================================
...
COMMENT ON FUNCTION handle_new_user IS 'Trigger création profil. Ultra-robuste, ne bloque JAMAIS. Gère OAuth (Google/Apple) et inscription manuelle.';
...
BEGIN
  RAISE NOTICE '';
  RAISE NOTICE '════════════════════════════════════════════════════════════════';
  RAISE NOTICE '✓ TRIGGER ULTRA-ROBUSTE ACTIVÉ';
  RAISE NOTICE '';
  RAISE NOTICE 'Changements:';
  RAISE NOTICE '  • Gestion d''erreur à chaque étape (BEGIN/EXCEPTION)';
  RAISE NOTICE '  • Ne bloque JAMAIS la transaction (RAISE WARNING)';
  RAISE NOTICE '  • Logs détaillés pour debugging';
  RAISE NOTICE '';
  RAISE NOTICE 'Le trigger devrait maintenant fonctionner pour:';
  RAISE NOTICE '  ✓ Inscription manuelle (first_name/last_name)';
  RAISE NOTICE '  ✓ OAuth Google (full_name parsé)';
  RAISE NOTICE '  ✓ OAuth Apple (given_name/family_name)';
  RAISE NOTICE '════════════════════════════════════════════════════════════════';
  RAISE NOTICE '';
END $$;
